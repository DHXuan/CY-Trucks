...
int main() {
  FILE* fichier1;
  FILE* fichier2;
  fichier1 = fopen("home/temp/StatsTrajets.txt", "r"); //ouverture mode lecture du fichier StatsTrajets.txt contenant les stats suivantes sur l'ensemble des trajets : Route ID, Min, Max, Moy, Diff
  fichier2 = fopen("home/resultats/ResultFinalStats.txt", "a"); //ouverture en mode ajout "add" d'un nouveau fichier.
