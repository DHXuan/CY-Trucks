...
plot 'StatsFinales.txt' using 2:xticlabels(1) with lines title 'Distances Max/Min (Km)' lc rgb "skyblue", '' u 4:xticlabels(1) with lines title "" lc rgb "skyblue", '' u 3 smooth mcs with lines title 'Distance moyenne (km)' lc rgb "#4863A0"
EOF
